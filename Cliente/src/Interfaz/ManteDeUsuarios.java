 ...
 * @author GRD
 */
public class ManteDeUsuarios extends javax.swing.JFrame {

    /**
     * Creates new form ManteDeUsuarios
     */
    public ManteDeUsuarios() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Seleccione al usuario a eliminar: ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManteDeUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManteDeUsuarios().setVisible(true);
            }
        });
    }
